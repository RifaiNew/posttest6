...
<body id="body">
    ...
    <div class="bottom-content">
        <div class="container">
            ...
            <div class="main-content">
                <?php 
                    if(isset($_SESSION["usernamebaru"]) && isset($_SESSION["nohp"])  ){?>
                        <p id="paragraf" style="color: rgba(113, 50, 0, 0.8);">HALO, <?php echo "Nama Saya : ", $_SESSION["usernamebaru"], " No. Hp ", $_SESSION["nohp"]?></p>
                <?php } ?>
            </div>
        </div>
    </div>
